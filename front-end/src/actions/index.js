...
export const login = creds => dispatch => {
    dispatch ({type:LOGIN});
    return axios.post('https://ptpt-use-my-tech-4.herokuapp.com/api/auth/login', creds).then(res => {
        console.log(res)
...
export const register = user => dispatch => {
    ...
    return axios.post('https://ptpt-use-my-tech-4.herokuapp.com/api/auth/register', user).then(res => {
        console.log(res)
